...
def main():
    ...
    parser.add_argument('--file_name', default='figure',
                        help='log dir (default: ./)')
    ...
    parser.add_argument('--save', action='store_true',
                        help='save figure')
    parser.add_argument('--show_hlines', action='store_true',
                        help='show figure')
    parser.add_argument('--show_hlines_y', type=float, default=1,
                        help='show_hlines_y')
    ...
    pu.plot_results(allresults,
                    ...
                    show_hlines=args.show_hlines,
                    show_hlines_y=args.show_hlines_y
                    )
    ...
    if args.save:
        if args.pdf:
            plt.savefig(args.file_name + '.pdf', dpi=args.dpi, bbox_inches='tight')
        else:
            plt.savefig(args.file_name, dpi=args.dpi, bbox_inches='tight')
    if args.show:
        plt.show()
